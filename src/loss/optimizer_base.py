"""
Base class for optimizers for backprob ops using the loss as param
"""
...
import torch
from src.utils.helpers import clip_grad_norm_
...
# class LegacyOptimizerBase(OptimizerBase):
