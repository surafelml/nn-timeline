...
from src.utils.helpers import item
from src.configs.configs import DataclassBase
from src.loss.criterion_base import CriterionBase
...
@dataclass
class ModelCriterionConfig(DataclassBase):
...
class ModelCriterion(CriterionBase):
    """
