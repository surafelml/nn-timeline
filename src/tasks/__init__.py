"""
There is bunch of code for task registration
TODO: remove unnecessary bunches
    - check how openmt-tf or sockeye task is setup
    - move all registring's (task, model, etc) to registration.py script in config
"""
...
def setup_task(cfg: DataclassBase, **kwargs):
    task = None
...
def register_task(name, dataclass=None):
    ...
    def register_task_cls(cls):
        ...
        #
        #     # FIXME: hydra related - commented all set
