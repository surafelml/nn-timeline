...
DDP_BACKEND_CHOICES = ChoiceEnum([
    ...
    "fully_sharded",  # FullyShardedDataParallel from fairscale  # Note: avoid this in v1.0
    "legacy_ddp",
    "no_c10d",  # alias for legacy_ddp
    "pytorch_ddp", # Note: focus on using this.
    "slow_mo",
])
...
# input-output start and end of sequence symbols
BOS='bos'
EOS='eos'